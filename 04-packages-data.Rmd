...
Then, access the project for this demonstration at [rstudio.cloud/project/360104](https://rstudio.cloud/project/360104). Opening this link will generate a temorary copy of the demonstration 
...
```
*Note--* Downloading all sites separately (query q/o POR date range), then subsetting to just those included in narrowresult.
